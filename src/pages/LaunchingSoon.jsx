        ...
        <>
            ...
            >
                ...
                <div className='text-center'>
                    <h1 className='text-6xl font-semibold text-white drop-shadow-[0_2px_2px_rgb(0,105,116)] mb-8'>
                        LAUNCHING SOON !!!
                    </h1>
                    <button
                        onClick={() => setIsModalOpen(true)}
                        className='bg-white py-4 px-32 rounded-full border border-[#38D3E3]'
                    >
