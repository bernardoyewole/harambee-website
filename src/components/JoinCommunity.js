        ...
        >
            <div>
                <div className='w-full flex justify-center'>
                    <img src={require("../assets/images/hourglass.png")} className='h-20' />
                </div>
                ...
                <div className="mt-4">
                    ...
                    <div className='relative w-full'>
                        <MdOutlineMail className='text-white absolute left-3 top-1/2 transform -translate-y-1/2 text-lg' />
                        <input
                            type="email"
                            placeholder="Enter email address"
                            className="bg-transparent border-b border-white py-2 text-sm text-white w-full pl-10 focus:outline-none"
                        />
                    </div>
